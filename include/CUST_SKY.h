...
#define FEATURE_PANTECH_STABILITY_AT_COMMAND //EF33S_ICS_NOVAPEX: AT_CMD_PZ1815_Merge
/*******************************************************************************
**  PDL
*******************************************************************************/
...
#if (BOARD_VER <= TP10)
#define FEATURE_SKY_NFC_ST21NFCA
#else
...
#define FEATURE_PANTECH_RAMDUMP_ONOFF // pz1714 20120514
...
#define FEATURE_SKY_WLAN_RAWDATA_ACCESS // BSH - build error temp
